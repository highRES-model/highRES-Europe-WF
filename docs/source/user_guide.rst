...
| One important miscellaneous equation is the :math:`CO_2` constraint (``eq_co2_budget``). It limits the total :math:`CO_2` emissions to be lower than a given value. The constraints scale with demand and as such indicate a maximum average emission intensity. By default, the intensity is 2gCO:sub:`2`/kWh. 
